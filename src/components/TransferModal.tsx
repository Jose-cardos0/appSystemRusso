    ...
    notification.innerHTML = `
      <div class="flex items-center gap-3 w-full">
        ...
        <div class="flex-1">
          ...
          <p class="text-[13px] text-white/90">${t("youTransferred")} ${t(
      "currency"
    )} ${transferAmount.toFixed(2)}</p>
        </div>
        <span class="text-[13px] text-white/70 self-start">${t("now")}</span>
      </div>
    `;
